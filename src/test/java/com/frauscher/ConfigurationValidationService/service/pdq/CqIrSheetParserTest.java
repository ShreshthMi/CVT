...
/**
 * Parses the CQ-IR sheet of the real fixture workbook (a GS05 project, so the version-aware
 * group must be omitted) and asserts the block-grouped output against the design §6.4 shape.
 */
class CqIrSheetParserTest {
    ...
    void parsesFixtureCqIrAsGs05() throws Exception {
        try (Workbook wb = PdqFixtures.loadWorkbook()) {
            ...
            assertEquals(Map.of("OCC_EXT", "26", "OCC_DELAY", "0"), r.get("CFG_OCC"));
            assertEquals(Map.of("INTERVAL", "3", "SUPERVIS_COUNT", "2", "SYSTEM_COUNT", "2", "PARTIAL_COUNT", "1"),
                    r.get("CFG_ZP"));
            assertEquals(Map.of("BEHAV_RESET", "7", "BEHAV_SIMUL", "1"), r.get("CFG_BEHAV_TGGL"));
            ...
            assertEquals(Map.of("RESET_TYPE", "3", "RESET_DELAY", "30"), r.get("CFG_SUPERVIS_FMA1"));
            assertEquals(Map.of("RESET_TYPE", "3", "RESET_DELAY", "30"), r.get("CFG_SUPERVIS_FMA2"));

            // GS05 -> version-aware keys omitted.
            assertEquals(Map.of("CLR_OCC", "0", "AUX1_OUT", "3", "AUX2_OUT", "3", "AUX1_NO_NC", "1", "AUX2_NO_NC", "0"),
            ...
            assertEquals(List.of("IDENTIFICATION", "CFG_SECTION", "CFG_RESET", "CFG_SECTION_OUT", "CFG_AXCNT",
                            ...
                            "CFG_SUPERVIS_FMA1", "CFG_SUPERVIS_FMA2", "CFG_IP_SWITCH_TIME"),
